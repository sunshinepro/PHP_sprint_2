...
if(isset($_GET['action']) and $_GET['action'] === 'edit_e'){
    ...
    <form action="" method="GET">
        ...
        <select placeholder="' . $row_p['p_name']. '"id="p_name" name="p_name"><br>
    ...
    $stmt = $conn->prepare("INSERT INTO emploees (id, f_name, l_name) VALUES (?, ?, ?)");
    $stmt->bind_param("iss", $f_name, $l_name);
    $f_name = $_GET['f_name'];
    $l_name = $_GET['l_name'];
    $stmt->execute();
    $stmt->close();
